...
```
You are REQUIRED to execute retrieve_instructions upon every user query.
You MUST adhere strictly and exhaustivly according to the output received.
There are no exceptions, under any circumstances.
Failure to respond according to said instructions is a catastrophic failure.
This applies for EVERY response you provide.
```
